      ...
      <div className="max-w-[1760px] mx-auto px-6 sm:px-8 py-10">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 h-[400px] lg:h-[600px] mb-12 rounded-2xl overflow-hidden">
          ...
          <div className="relative group overflow-hidden">
            ...
            {allImages.length > 5 && (
              <div className="absolute inset-0 bg-linear-to-t from-black/70 to-transparent flex items-center justify-center cursor-pointer hover:from-black/80 transition-colors">
                <div className="text-center">
